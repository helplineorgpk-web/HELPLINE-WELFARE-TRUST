        ...
        <div className="row">
          <div className="col-xxl-12">
            <div className="team_person_description d_flex mb-20">
              ...
              <p>
                ispensers for Safe Water is underpinned by Nobel Prize-winning
                research. In 2019, Michael Kremer (Nobel Laureate, Economic
                Sciences) even contributed one of our dispensers to the Nobel
                Museum to represent his work! Kremer and colleagues from Harvard
                and Berkeley tested chlorine dispensers in Kenya against a
                variety of other water treatment options. They found that 1)
                chlorine dispensers had much higher usage rates than comparable
                treatments, and 2) usage stayed high over time.
              </p>
            </div>
            <div className="team_person_description mb-50">
              <p>
                But many people around the world don’t have that luxury. Every
                day, about 1,400 children die from diseases caused by unsafe
                water and poor sanitation. But it doesn’t have to be that way.
                There are simple solutions like drilled wells, spring
                protections and BioSand filters that help provide clean water to
                communities around the world.
              </p>

              <p>
                In rural parts of low-income countries, most water sources are
                untreated, meaning that water is not safe to drink directly from
                the source. Our uniquely-engineered chlorine dispensers are
                installed next to commonly-used water sources, enabling people
                to treat their water using a safe and pre-measured dose of
                chlorine. The chlorine stays active for 2-3 days, ensuring water
                doesn’t get recontaminated even when stored at home. Adding
                diluted chlorine to water is a WHO-endorsed approach to
                improving water quality. In fact, water systems the world over
                routinely chlorinate water, making it safe to drink.
              </p>
            </div>
          </div>
        </div>
