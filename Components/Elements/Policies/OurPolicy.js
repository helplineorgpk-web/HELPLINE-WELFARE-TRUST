...
import styles from '../../../public/css/OurPolicy.module.css';

export default function OurPolicy() {
  return (
    <section className={styles.policyDocument}>
      <div className={styles.container}>
        <div className={styles.documentWrapper}>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.paragraph}>
              Your use of this website and any dispute arising out of such use of the website is subject to the laws of Pakistan. In case you have any questions or complaints, please write to us at info@helplinewelfaretrust.org
            </p>
          </div>
          ...
          <div className={styles.section}>
            <h2 className={styles.sectionTitle}>Donation Acknowledgment Policy (Delivery Policy)</h2>
            <p className={styles.paragraph}>
              Donors will get a formal acknowledgment of the donations in terms of proper receipt via email, SMS, and WhatsApp Terms and Conditions If we ever make any changes to our donor's privacy policy, we will straightforwardly post any changes on our website so that you are always up-to-date regarding the information that we collect and how do we utilize it.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.paragraph}>
              There are different types of cookies: session cookies, persistent cookies, first-party cookies, functionality cookies, performance cookies, and third-party cookies. Session cookies are deleted from your computer when you close your browser, whereas persistent cookies remain stored on your computer until deleted or until they reach their expiry date. Performance cookies allow us to monitor visits and traffic sources to improve our website's performance, while functionality cookies enable the website to provide enhanced functionality and personalization.
            </p>
          </div>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.paragraph}>
              Recent developments have changed how third-party cookies are managed. You can now manage third-party cookies on different devices. For more details, visit Google Privacy Tools. Some or all of these cookies or similar technologies may be stored in your browser, app, or device. You can also manage cookies through your browser settings, though the options available may vary depending on the browser or device you are using.
            </p>
          </div>
