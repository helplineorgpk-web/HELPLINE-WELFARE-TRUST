...
export default function LivelihoodSuccessStoryDetail({ story }) {
  if (!story) return null;

  const badge = story.badge || "Livelihood";
    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        <nav className={styles.breadcrumb} aria-label="Breadcrumb">
          ...
          <Link href="/livelihood">Livelihood</Link>
          <span aria-hidden="true">/</span>
        ...
        <article className={styles.article}>
          ...
          <div className={styles.body}>
            ...
            <div className={styles.actions}>
              <Link href="/livelihood" className={styles.btnPrimary}>
                Explore our livelihood work
              </Link>
              <Link
                href="/livelihood#success-stories-heading"
                className={styles.btnSecondary}
              >
                More livelihood stories
              </Link>
            </div>
          </div>
        </article>
