      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6">
            <Link href="/cause">
              <a className="single_iconbox text-center theme-1 mb-40">
          ...
          <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6">
            <Link href="/cause">
              <a className="single_iconbox text-center theme-2 mb-40">
          ...
          <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6">
            <Link href="/cause">
              <a className="single_iconbox text-center theme-3 mb-40">
          ...
          <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6">
            <Link href="/cause">
              <a className="single_iconbox text-center theme-5 mb-40">
          ...
          <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-4 col-sm-6">
            <Link href="/cause">
              <a className="single_iconbox text-center theme-6 mb-40">
