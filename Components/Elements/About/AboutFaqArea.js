  ...
  const defaultAccordion = [
    {
      ...
      desc: "We are called by God to to raise awareness of the 147 million orphaned and abandoned children in our world and then educate and equip people with the resources.",
    },
    {
          ...
          <div className="col-xxl-5 col-xl-5">
            <div className="accordion_wrapper mr-30">
              <div className="section_title mb-50">
                ...
                <h3 className="title title_2">Get every answers from here.</h3>
              </div>
