            ...
            <div className="single_details_wrapper mb-40">
              ...
              <div className="single_details_content">
                ...
                <p className="mb-40">
                  ...
                  \person or persons in need; alms: She asked for work, not
                  charity. a charitable act or work. Thank you so much for
                  visiting my page, something I never thought I would be setting
                  up. Having fought stage IV cancer for almost two years, I have
                  ran out of options which makes my diagnosis terminal{" "}
                </p>
                <p className="mb-30">
                ...
                <p className="single_border pb-55 mb-50">
                  At its most basic, charity means: giving someone something
                  they need but can&apos;t get for themselves. And normal
                  that&apos;s understood to mean something material. We
                  overwhelmingly associate charity with giving money. The heroes
                  of Christianity are exemplars of such charity.
                </p>
