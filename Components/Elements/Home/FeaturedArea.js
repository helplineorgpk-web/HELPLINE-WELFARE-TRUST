...
export default function FeaturedArea() {
  return (
    ...
    <div
      className="f_event_area bg_cover p-rel pt-105 pb-120"
      style={{ backgroundImage: "url(/img/featureEvent/fevent_bg.jpg)" }}
    >
          ...
          <div className="col-xxl-12">
            <div className="section_title text-center mb-45">
              <span className="sub_title">
                <i className="fal fa-heart"></i> Events
              </span>
          ...
          <div className="col-xxl-12">
            <div className="fevent_table">
              <div className="fevent_wrapper">
                <div
                  className="fevent_heading bg_cover"
                  style={{
                    background: "url(/img/featureEvent/heading_bg.jpg)",
                  }}
                  data-overlay="theme"
                  data-opacity="9"
                >
                ...
                <div className="single_fevent_wrapper">
                  <div className="single_fevent event_border">
                    <div className="fdate single_fdate theme-3">
                  ...
                  <div className="single_fevent event_border">
                    <div className="fdate single_fdate theme-2">
                  ...
                  <div className="single_fevent">
                    <div className="fdate single_fdate theme-1">
