              ...
              <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12 d-flex align-items-center">
                <div className="support_wrapper">
                  <div className="section_title">
                    ...
                    <h3 className="title">
                      Become an volunteer for save children
                    </h3>
                  </div>
                  <p className="mb-45">
                    NewLook unlike many traditional plastic surgery centers in
                    San Diego, are industry recognized experts in a wide variety
                    of with an cosmetic procedure and are dedicated
                  </p>
                  <Link href="/volunteer">
          ...
          <div className="row">
            ...
            <div className="col-xxl-6 col-xl-6 col-lg-12 col-sm-12 d-flex align-items-center text-center">
              <div
                ...
                style-={{
                  backgroundImage: "url(assets/img/bg/support_bg.jpg)",
                }}
              >
                <form action="#">
