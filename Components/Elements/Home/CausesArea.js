...
export default function CausesArea() {
  return (
    ...
    <section
      ...
      style={{ "background-image": "url(/img/causes/cause_map.png)" }}
    >
          ...
          >
            <SwiperSlide className="single_cause mb-30">
              <div className="single_cause_img img_effect_white p-rel">
                <Link href="/cause-details">
                  <a>
                    <img src="/img/causes/cause1.jpg" alt="img" />
                  </a>
                </Link>
              ...
              <div className="single_cause_content single_cause_content_2">
                <div className="single_cause">
                  <h3 className="title">
                    <Link href="/cause-details">
                      <a>The various agency help the poor, you also can try.</a>
                    </Link>
                  </h3>
                </div>
            ...
            <SwiperSlide className="single_cause mb-30">
              <div className="single_cause_img p-rel img_effect_white">
                <Link href="/cause-details">
                  <a>
                    <img src="/img/causes/cause17.jpg" alt="img" />
                  </a>
                </Link>
              ...
              <div className="single_cause_content single_cause_content_2">
                <div className="single_cause">
                  <h3 className="title">
                    <Link href="/cause-details">
                      <a>
                        If poor will well educated, you and you country will be
                        rich.
                      </a>
                    </Link>
                  </h3>
            ...
            <SwiperSlide className="single_cause mb-30">
              <div className="single_cause_img p-rel img_effect_white">
                <Link href="/cause-details">
                  <a>
                    <img src="/img/causes/cause3.jpg" alt="img" />
                  </a>
                </Link>
              ...
              <div className="single_cause_content single_cause_content_2">
                <div className="single_cause">
                  <h3 className="title">
                    <Link href="/cause-details">
                      <a>Give your helping hand to teach poor people always</a>
                    </Link>
                  </h3>
                </div>
                <div className="single_cause_meta">
              ...
              <div className="single_cause_content single_cause_content_2">
                <div className="single_cause">
                  <h3 className="title">
                    <Link href="/cause-details">
                      <a>
                        We have to careful and helpful to poor people always.
                      </a>
                    </Link>
                  </h3>
                </div>
              ...
              <div className="single_cause_content single_cause_content_2">
                <div className="single_cause">
                  <h3 className="title">
                    <Link href="/cause-details">
                      <a>
                        Share your money to serve poor people as far possible.
                      </a>
                    </Link>
                  </h3>
                </div>
            ...
            <SwiperSlide className="single_cause mb-30">
              <div className="single_cause_img p-rel img_effect_white">
                <Link href="/cause-details">
                  <a>
                    <img src="/img/causes/cause12.jpg" alt="img" />
                  </a>
                </Link>
                <div className="progress_wrapper pbar_3">
                  <div className="progress_circle" data-percentage="80">
              ...
              <div className="single_cause_content single_cause_content_2">
                <div className="single_cause">
                  <h3 className="title">
                    <Link href="/cause-details">
                      <a>
                        Donate now to forward for poor at this pandemic time.
                      </a>
                    </Link>
                  </h3>
                </div>
            ...
            <SwiperSlide className="single_cause mb-30">
              <div className="single_cause_img p-rel img_effect_white">
                <Link href="/cause-details">
                  <a>
                    <img src="/img/causes/cause24.jpg" alt="img" />
                  </a>
                </Link>
                <div className="progress_wrapper pbar_3">
                  <div className="progress_circle" data-percentage="80">
              ...
              <div className="single_cause_content single_cause_content_2">
                <div className="single_cause">
                  <h3 className="title">
                    <Link href="/cause-details">
                      <a>Putting the power of law in people&apos;s hand</a>
                    </Link>
                  </h3>
                </div>
                <div className="single_cause_meta">
