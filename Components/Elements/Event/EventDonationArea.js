        ...
        <div className="row flex-column-reverse flex-md-row">
          <div className="col-xxl-4 col-xl-5 col-lg-6 col-md-6">
            <div className="donation_wrappar">
              ...
              <span className="opacity_6">
                100% of your helping donation funds spinal cord research.
              </span>
              <div className="donate_progress_wrapper">
                <label className="event_lab">
                  Raised: <span className="theme-3">$1,25,000</span>
                </label>
                <div className="progress donate_progress">
                  <div
                    className="progress-bar theme-3"
                    role="progressbar"
                    style={{ width: "30%" }}
                  ></div>
                </div>
              ...
              <div className="support_search_section event_single mb-20">
                ...
                >
                  ...
                  <ul className="list">
                    ...
                    <li onClick={() => setSelect("EUR")} className="option">
                      EUR
                    </li>
                    <li
                    ...
                    <li onClick={() => setSelect("BDT")} className="option">
                      BDT
                    </li>
                  </ul>
                </div>
          ...
          <div className="col-xxl-8 col-xl-7 col-lg-6 col-md-6">
            <div className="donate_img_wrapper ml-70">
              <div className="donate_img_inner p-rel">
                ...
                <img
                  className="abs_img event_abs_img"
                  src="/img/donation/events_abs.jpg"
                  alt="img"
                />
              </div>
            </div>
