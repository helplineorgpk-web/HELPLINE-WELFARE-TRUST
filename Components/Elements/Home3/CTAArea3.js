        ...
        <div className="row g-0">
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
            <div className="cta_single cta_color_1">
              ...
              <p>
                Don’t make you hurter for saving this world. Just we are like
          ...
          <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6">
            <div className="cta_single cta_color_2">
              ...
              <p>
                Join with our creative & friendly team in easy way for move
          ...
          <div className="col-xxl-6 col-xl-12 col-lg-12 col-md-12">
            <div
              className="video_wrapper video_wrapper_3"
            ...
            {isPopUp && (
              <VideoPopUp
                ...
                src={"https://www.youtube.com/embed/B4GwnBrp41s"}
              />
            )}
          </div>
        </div>
